...
<body class="h-full bg-slate-50 overflow-hidden">
    ...
    <div class="h-full flex flex-col relative">
        ...
        <div class="absolute top-[-10%] right-[-10%] w-64 h-64 bg-indigo-600/10 rounded-full blur-3xl animate-float"></div>
        ...
        <div class="px-8 pt-16 pb-8 text-center relative z-10">
            <div class="inline-flex items-center justify-center w-20 h-20 bg-white rounded-3xl shadow-xl shadow-indigo-100 mb-6 p-4">
                @if ($logo)
        ...
        <div class="flex-1 px-8 relative z-10">
            <div class="bg-white/80 backdrop-blur-xl border border-white rounded-[40px] p-8 shadow-2xl shadow-indigo-100/50">
                <form action="{{ route('login') }}" method="POST" class="space-y-6">
                    @csrf
                    
                    @if ($errors->any())
                        <div class="bg-red-50 border border-red-100 text-red-600 px-4 py-3 rounded-2xl text-xs font-bold flex items-center gap-3 animate-shake">
                    ...
                    <div class="space-y-2">
                        <label for="email" class="text-[10px] font-black text-indigo-600 uppercase tracking-widest ml-1">Alamat Email</label>
                    ...
                    <div class="space-y-2">
                        <label for="password" class="text-[10px] font-black text-indigo-600 uppercase tracking-widest ml-1">Kata Sandi</label>
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400 group-focus-within:text-indigo-600 transition-colors">
                            ...
                            <input type="password" name="password" id="password" 
                                ...
                                placeholder="••••••••"
                                required>
                            <button type="button" onclick="togglePassword()" class="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-indigo-600">
                    ...
                    <div class="flex items-center justify-between px-1">
                        <label class="flex items-center gap-2 cursor-pointer group">
                            <div class="relative flex items-center">
                                ...
                                <div class="w-5 h-5 border-2 border-gray-200 rounded-lg peer-checked:bg-indigo-600 peer-checked:border-indigo-600 transition-all"></div>
                                <i class='bx bx-check absolute text-white opacity-0 peer-checked:opacity-100 left-0.5'></i>
                            </div>
                            <span class="text-xs font-bold text-gray-500 group-hover:text-indigo-600 transition-colors">Ingat Saya</span>
                        </label>
                    </div>
        ...
        <div class="px-8 py-10 text-center relative z-10">
            ...
            <div class="flex gap-4 justify-center">
                <a href="#" class="w-10 h-10 bg-white rounded-xl shadow-md flex items-center justify-center text-indigo-600">
