...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-8 mb-4">
            <x-card title="Pengguna Terdaftar Baru" class="h-100">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <x-card title="Aktivitas Terkini" class="h-100">
                <x-slot name="headerAction">
    ...
    <div class="row">
        ...
        <div class="col-lg-8 mb-4">
            <x-card title="Aktivitas Mingguan">
                <x-slot name="headerAction">
                    <div class="dropdown">
        ...
        <div class="col-lg-4 mb-4">
            <x-card title="Distribusi Pengguna" class="h-100">
