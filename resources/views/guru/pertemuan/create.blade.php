        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Buat Pertemuan Baru: {{ $jadwal->mataPelajaran->nama_mapel }} -
                        {{ $jadwal->kelas->nama_kelas }}</h5>
                    ...
                    <form action="{{ route('guru.pertemuan.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="pertemuan_ke">Pertemuan Ke <span
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="judul_pertemuan" name="judul_pertemuan" value="{{ old('judul_pertemuan') }}"
