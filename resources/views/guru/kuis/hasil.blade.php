                    ...
                    <tbody class="table-border-bottom-0">
                        @forelse ($hasil as $h)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-start align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <span class="text-truncate fw-semibold">{{ $h->siswa->nama_lengkap }}</span>
                                ...
                                <td>
                                    <a href="{{ route('guru.kuis.review', $h->id) }}" class="btn btn-sm btn-primary">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-5">Belum ada siswa yang mengerjakan kuis ini.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
