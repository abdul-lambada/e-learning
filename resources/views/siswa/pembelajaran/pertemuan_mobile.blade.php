            ...
            @forelse($pertemuan->materiPembelajaran as $materi)
                <div class="bg-white rounded-3xl p-4 shadow-sm border border-gray-100 space-y-4">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            <h4 class="font-bold text-gray-900 text-sm leading-tight">{{ $materi->judul_materi }}</h4>
                    ...
                    <div class="rounded-2xl overflow-hidden bg-gray-50">
                        ...
                        @elseif($materi->tipe_materi == 'link')
                            <a href="{{ $materi->link_url }}" target="_blank"
                                ...
                                <i
                                    class='bx bx-link-external text-blue-400 group-hover:translate-x-1 transition-transform'></i>
                            </a>
                        @elseif($materi->tipe_materi == 'file')
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100">
                ...
                <div id="diskusi-container"
                    class="p-4 space-y-6 min-h-[100px] max-h-[400px] overflow-y-auto hide-scrollbar">
