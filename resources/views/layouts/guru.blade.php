            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    @can('lihat mata pelajaran')
                        <li class="menu-item {{ request()->routeIs('guru.mapel.*') ? 'active' : '' }}">
                            <a href="{{ route('guru.jadwal.index') }}" class="menu-link">
                    ...
                    @can('lihat absensi')
                        <li
                            class="menu-item {{ request()->routeIs('guru.absensi.*') || request()->routeIs('guru.laporan.absensi') ? 'active open' : '' }}">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h6 class="mb-1">Tugas baru dikumpulkan</h6>
                                                        <p class="mb-0">5 siswa mengumpulkan tugas</p>
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div
                            ...
                            <div class="mb-2 mb-md-0">
                                © {{ date('Y') }}, E-Learning System - Portal Guru
                            </div>
                            <div>
                                <span class="text-muted">NIP: {{ auth()->user()->nip }}</span>
                            </div>
                        </div>
                    </footer>
                    <!-- / Footer -->
